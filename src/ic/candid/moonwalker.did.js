export default ({ IDL }) => {
  ...
  const MoonWalker = IDL.Service({
    ...
    'getAllAssets' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(AssetHandle, IDL.Vec(Asset)))],
        ['query'],
      ),
    'getAssetHandles' : IDL.Func(
        [],
        [
          IDL.Vec(
            IDL.Tuple(
              AssetHandle,
              IDL.Tuple(IDL.Text, IDL.Nat32),
              IDL.Tuple(IDL.Text, IDL.Nat32),
            )
          ),
        ],
    ...
    'getAssets' : IDL.Func([AssetHandle], [IDL.Opt(IDL.Vec(Asset))], ['query']),
    'getAssetsSlice' : IDL.Func(
        [IDL.Nat, IDL.Nat],
        [IDL.Vec(IDL.Tuple(AssetHandle, IDL.Vec(Asset)))],
        ['query'],
      ),
    ...
    'reserve' : IDL.Func(
        [IDL.Nat64, AssetHandle, AccountIdentifier_3, SubAccount_3],
        [Result_7],
        [],
      ),
    ...
    'salesStats' : IDL.Func(
        [AccountIdentifier_3],
        [IDL.Nat64, IDL.Opt(IDL.Nat8), Time, IDL.Vec(IDL.Text)],
        ['query'],
      ),
