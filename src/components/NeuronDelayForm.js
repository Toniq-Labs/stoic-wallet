      ...
      >
        ...
        <DialogContent>
          <DialogContentText style={{textAlign: 'center'}}>
            Please enter the amount you want to <strong>increase your Dissolve Delay</strong> - this
            is the length of time it takes for the ICP contained within this neuron to become
            available once it is set to dissolve.
          </DialogContentText>
          <TextField
            autoFocus
            margin="dense"
          ...
          <DialogContentText style={{fontSize: 'small', textAlign: 'center', marginTop: '20px'}}>
            ...
            {delay ? (
              <strong>New Dissolve Delay: {formatDate(props.currentDelay + delay)}</strong>
            ) : (
              ''
            )}
          </DialogContentText>
        ...
        <DialogActions>
          ...
          <Button onClick={() => props.onSubmit(delay)} color="primary">
            Confirm Change
          </Button>
        </DialogActions>
      </Dialog>
