...
export default function WalletDialog(props) {
  ...
  const confirmMnemonic = () => {
    if (!StoicIdentity.validateMnemonic(mnemonic))
      return error('The mnemonic you entered is not valid'); //show error
    if (type === 'create' && mnemonic !== newMnemonic)
      return error('The mnemonic you entered does not match the one displayed'); //show error
    setRoute('passwords');
  };
            ...
            <DialogContent>
              <List component="nav" aria-label="secondary add principal">
                <ListItem button onClick={() => directuath('google')}>
                  ...
                  <ListItemText primary="Google" secondary="Login using your Google account" />
                </ListItem>
                <ListItem button onClick={() => directuath('github')}>
                  <ListItemIcon>
                    <GitHubIcon />
                  </ListItemIcon>
                  <ListItemText primary="Github" secondary="Login using your Github account" />
                </ListItem>
                <ListItem button onClick={() => directuath('twitter')}>
                  <ListItemIcon>
                    <TwitterIcon />
                  </ListItemIcon>
                  <ListItemText primary="Twitter" secondary="Login using your Twitter account" />
                </ListItem>
                <ListItem button onClick={() => directuath('facebook')}>
                  <ListItemIcon>
                    <FacebookIcon />
                  </ListItemIcon>
                  <ListItemText primary="Facebook" secondary="Login using your Facebook account" />
                </ListItem>
              </List>
            </DialogContent>
            <DialogActions>
      ...
      {route === 'tips' ? (
        <>
          ...
          >
            ...
            <DialogContent>
              <p>
                <strong>Things to keep in mind to increase the security of your funds:</strong>
              </p>
              <ul>
                {tips.map((t, i) => {
            ...
            <DialogActions>
              ...
              {tipsIndex < tips.length ? (
                <Button onClick={() => setTipsIndex(tipsIndex + 1)} color="primary">
                  Next Tip
                </Button>
              ) : (
                <Button onClick={showNewMnemonic} color="primary">
                  Continue
                </Button>
              )}
            </DialogActions>
      ...
      {route === 'newMnemonic' ? (
        <>
          ...
          >
            ...
            <DialogContent>
              <p>
                <strong>This is your 12 word seed phrase:</strong>
              </p>
              <div style={{textAlign: 'center'}}>
                {newMnemonic.split(' ').map((w, i) => {
                  return (
                    <span
                      key={i}
                      style={{fontSize: 'large', display: 'inline-block', padding: '5px 15px'}}
                    >
                      {w}
                      {i < 11 ? <>&nbsp;</> : ''}
                    </span>
              ...
              <p>
                Write your mnemonic down on a physical piece of paper and store it somewhere safe
                and private. Anyone who knows this can transfer funds out of your account.
              </p>
              <p style={{fontWeight: 'bold'}}>
                Note: Stoic does not store your seed phrase anywhere and cannot recover it for you
                in case you lose it.
              </p>
            ...
            <DialogActions>
              ...
              <Button onClick={() => setRoute('confirmMnemonic')} color="primary">
                Continue
              </Button>
            </DialogActions>
          </Dialog>
      ...
      {route === 'confirmMnemonic' ? (
        <>
          ...
          >
            ...
            <DialogContent>
              <p>
                <strong>Please confirm your 12 word seed phrase:</strong>
              </p>
              <TextField
            ...
            <DialogActions>
              ...
              <Button onClick={confirmMnemonic} color="primary">
                Continue
              </Button>
            </DialogActions>
          </Dialog>
      ...
      {route === 'address' ? (
        <>
          ...
          >
            ...
            <DialogContent>
              <p>
                <strong>Please enter a valid Principal (e.g. 4opr7-aaepd-uw2ok...)</strong>
              </p>
              <TextField
                id="standard-textarea"
                label="Principal"
            ...
            <DialogActions>
              ...
              <Button onClick={confirmAddress} color="primary">
                Continue
              </Button>
            </DialogActions>
          </Dialog>
        ...
        <>
          ...
          >
            ...
            <DialogContent>
              <p>
                <strong>
                  This password is used to further encrypt your private data on your device.
            ...
            <DialogActions>
              ...
              <Button onClick={confirmPasswords} color="primary">
                Continue
              </Button>
            </DialogActions>
          </Dialog>
