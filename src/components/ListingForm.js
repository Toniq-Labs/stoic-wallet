        ...
        <DialogContent>
          {props.nft.price === 0 ? (
            <DialogContentText style={{textAlign: 'center', fontWeight: 'bold'}}>
              ...
              listing, it becomes available to the public. There is a 1.5% commission fee on all
              sales
            </DialogContentText>
          ) : (
            ''
          ...
          {props.nft.price > 0 ? (
            <DialogContentText style={{textAlign: 'center', fontWeight: 'bold'}}>
              Use the form to update the price of your listing, or Cancel the listing below
            </DialogContentText>
          ) : (
            ''
          )}
